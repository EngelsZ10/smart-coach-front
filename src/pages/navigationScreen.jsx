        ...
        <MantineProvider withGlobalStyles withNormalizeCSS>    
          ...
          <div className='navMenu'>
            ...
            <div className='navLogos'>
              <img src="Logos/Logo circular 2.png" alt="Logo Circular 2" className="navLogo"/>  
              <img src="Logos/logo texto1.png" alt="Logo texto 1" className="navLogo2"/>
            </div>

            <div className='navOptions'>
              
              <Text className="Title2" style={{color:'white'}}>ELIJA LA OPCIÓN DESEADA DANDO CLICK EN EL RECUADRO</Text>
